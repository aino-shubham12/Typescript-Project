...
class MainUI {
    ...
    addContainer = document.getElementsByClassName("add-container")[0];
    ...
    addUI() {
        ...
        this.addButton.onclick = () => {
            ...
            this.person = (<HTMLInputElement>document.getElementById("Pname")).value;
            ...
            this.pincode = (<HTMLInputElement>document.getElementById("Pincode")).value;
...
class Addresslist {
    ...
    updateAddress(i: number, add: Address): void {
...
class Findlist {
    ...
    findcontainer = document.getElementsByClassName("find-container")[0];
                    ...
                    this.editButton.onclick = () => {
                        ...
                        updateButton.onclick = () => {
                            ...
                            if (confirm('Are you sure to update this Address ?')) {
                                ...
                                var personValue = (<HTMLInputElement>document.getElementById("Person")).value;
                                var streetValue = (<HTMLInputElement>document.getElementById("Street")).value;
                                var cityValue = (<HTMLInputElement>document.getElementById("City")).value;
                                var pincodeValue = (<HTMLInputElement>document.getElementById("Pincode")).value;
